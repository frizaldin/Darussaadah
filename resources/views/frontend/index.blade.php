...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/frontend')}}/css/animating.css">
    <!-- owl carousel -->
    ...
    <!-- magic-mouse -->
    <link rel="stylesheet" href="{{asset('/frontend')}}/css/magic-mouse.css">
    <!-- simple-line-icons -->
...
<body class="menu-layer">
    ...
    <header class="two three" id="stickyHeader">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-2">
                    <div class="logo-icon">
                        <a class="magic-hover magic-hover__square" href="index.html">
                            <img class="light" src="img/orix-logo.png" alt="logo">
                            <img class="drak" src="img/black-logo.png" alt="logo">
                        </a>
                    ...
                    <div class="menu-bar">
                        <nav>
                            <ul>
                                ...
                                <li class="menu-item-has-children"><a class="magic-hover magic-hover__square" href="#">Services</a>
                                    <ul>
                                ...
                                <li class="menu-item-has-children"><a class="magic-hover magic-hover__square" href="#">Blog</a>
                                    <ul>
                                        <li><a class="magic-hover magic-hover__square" href="our-blog.html">Our Blog</a></li>
                                ...
                                <li class="menu-item-has-children"><a class="magic-hover magic-hover__square" href="#">Pages</a>
                                    <ul>
                                        ...
                                        <li><a class="magic-hover magic-hover__square" href="pricing-plans.html">Pricing Plans</a></li>
                ...
                <div class="col-xl-3">
                    <div class="extras">
                        <a href="javascript:void(0)" id="desktop-menu" class="magic-hover magic-hover__square menu-btn">
                    ...
                    <div class="menu-inner ps ps--active-x ps--active-y">
                        ...
                        <div class="contact-info">
                            ...
                            <ul class="recent-news gallery-photos">
                                <li>
                                    <a class="magic-hover magic-hover__square" href="https://via.placeholder.com/97x97" data-fancybox="gallery"><img alt="girl" src="https://via.placeholder.com/97x97"></a>
                                </li>
                                <li>
                                    <a class="magic-hover magic-hover__square" href="https://via.placeholder.com/97x97" data-fancybox="gallery"><img alt="girl" src="https://via.placeholder.com/97x97"></a>
                                </li>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12" data-aos="fade-up" data-aos-delay="300" data-aos-duration="500">
                    <div class="hero-section-img">
                        <img alt="hero-girl-img" src="{{asset('Header/'. $header->photo)}}">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
                    <div class="about-mee">
                        ...
                        <ul class="social-media-icon">
                            <li><a href="pdf/orix.pdf" class="magic-hover magic-hover__square button button--moema button--text-thick button--text-upper button--size-s"><i class="fa-solid fa-download" target="_blank"></i>Download CV</a></li>
                        ...
                        <ul class="age">
                            <li>
                                <h6>Umur:<span>{{$about->umur}}</span></h6>
                            </li>
                            <li>
                                <h6>Wilayah:<span>{{$about->wilayah}}</span></h6>
                            </li>
                            <li>
                                <h6>Alamat:<span>{{$about->alamat}}</span></h6>
                            </li>
                            <li>
                                <h6>E-mail:<span>{{$about->email}}</span></h6>
                            </li>
                            <li>
                                <h6>No Telp:<span>{{$about->phone}}</span></h6>
                            </li>
                            <li>
                                <h6>Pekerjaan:<span>{{$about->pekerjaan}}</span></h6>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="300" data-aos-duration="400">
                    <div class="progress-data">
                        <p>{{$about->deskripsi}} </p>
                        <img alt="sine" style="width:100%" src="{{asset('About/' . $about->file)}}">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
                    <div class="service-data">
                        ...
                        <h5><a class="magic-hover magic-hover__square" href="services-details.html">Graphichs Design</a></h5>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="400" data-aos-duration="500">
                    <div class="service-data">
                        ...
                        <h5><a class="magic-hover magic-hover__square" href="services-details.html">Stunning Design</a></h5>
                        <p>Lorem ipm dolor amet, consectetur
                            magm maiores.Ipsa dolor sit ilmesy
                            magnam maores.</p>
                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
                    <div class="service-data">
                        ...
                        <h5><a class="magic-hover magic-hover__square" href="services-details.html">Immigration Application</a></h5>
                        <p>Lorem ipm dolor amet, consectetur
                            magm maiores.Ipsa dolor sit ilmesy
                            magnam maores.</p>
                    </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up" data-aos-delay="400" data-aos-duration="500">
                    <div class="service-data">
                        ...
                        <h5><a class="magic-hover magic-hover__square" href="services-details.html">Project Management</a></h5>
                        <p>Lorem ipm dolor amet, consectetur
                            magm maiores.Ipsa dolor sit ilmesy
                            magnam maores.</p>
                    </div>
                        ...
                        <div class="portfolio-detail">
                            <div class="portfolio-img">
                                <figure class="gap-img">
                                    <img class="one hove" alt="profile img" src="{{asset('Gallery/' . $item->file)}}">
                                    <div class="hover-data">
                                        <a class="magic-hover magic-hover__square" href="#">{{$item->judul}}</a>
                                        <p>{{$item->subjudul}}</p>
                                    </div>
                                </figure>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
                    <div class="blog-data">
                        ...
                        <div class="message-icon"><i class="fa-solid fa-message"></i><span>12</span></div>
                        <h6>December 5, 2023 <span>|</span> John Smith</h6>
                        <h4><a class="magic-hover magic-hover__square" href="#">Interview Photographer
                                Mark Seliger</a></h4>
                        <p>Duis sed odio sit amet nibh vulputate
                            cursus a sit Using an interactive app
                            amet nibh roach.</p>
                        <a class="magic-hover magic-hover__square" href="#"><i class="fa-solid fa-angle-right"></i></a>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="300" data-aos-duration="400">
                    <div class="blog-data">
                        <img alt="blog img" src="https://via.placeholder.com/390x269">
                        <div class="message-icon"><i class="fa-solid fa-message"></i><span>22</span></div>
                        <h6>December 5, 2023 <span>|</span> John Smith</h6>
                        <h4><a class="magic-hover magic-hover__square" href="#">Professionals with a
                                Global Mindset</a></h4>
                        <p>Duis sed odio sit amet nibh vulputate
                            cursus a sit Using an interactive app
                            amet nibh roach.</p>
                ...
                <div class="col-xl-4 col-lg-6 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="400" data-aos-duration="500">
                    <div class="blog-data">
                        <img alt="blog img" src="https://via.placeholder.com/390x269">
                        <div class="message-icon"><i class="fa-solid fa-message"></i><span>12</span></div>
                        <h6>December 5, 2023 <span>|</span> John Smith</h6>
                        <h4><a class="magic-hover magic-hover__square" href="#">Reimagine, Restructure
                ...
                <div class="load-button" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
                    <a href="#" class="magic-hover magic-hover__square button button--moema button--text-thick button--text-upper button--size-s">View All News</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12" data-aos="fade-up" data-aos-delay="300" data-aos-duration="400">
                    <div class="your-name" style="background-image: url(./img/blur-1.png)">
                        <form class="one">
    ...
    <footer class="gap" style="background-image: url(./img/footer.png)">
        <div class="container">
    ...
    <script src="{{asset('/frontend')}}/js/isotope-init-home-1.js"></script>
